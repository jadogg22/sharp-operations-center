...
const reports = {
  ...
  vacation: { eyebrow: 'People operations', title: 'Vacation balances', description: 'Review current employee vacation balances and estimated payout amounts in one exportable view.', button: 'View balances', format: 'CSV' },
